// // ✅ OPTIMIZED: Hero section - LCP fix, no render-blocking
...
//           {/* ✅ H1 font-size mobile pe 3xl (was same) — already good */}
...
//           </p>
//           {/* ✅ Used <a> correctly - good for LCP (no JS needed) */}
//           <a
//             href="https://calendly.com/decasofts-appointment/meeting"
//             target="_blank"
//             rel="noopener noreferrer"
//             className="border-2 border-white text-white font-bold px-8 py-3 rounded hover:bg-white hover:text-primary transition-all text-sm tracking-wide uppercase inline-block"
//           >
//             Book a consultation
//           </a>
//         </div>

//         {/* ✅ Font Awesome icons — make sure FA loads via next/font or async script, not render-blocking */}
...
//               >
//                 <i className={`${icon} text-white text-lg`} aria-hidden="true"></i>
//               </div>
//             ))}
//           </div>
//         </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-20 w-full">
        <div className="max-w-2xl">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="block sm:inline-block text-center border-2 border-white text-white font-bold px-8 py-3 rounded hover:bg-white hover:text-primary transition-all text-sm tracking-wide uppercase"
          >
            Book a consultation
          </a>
        </div>
