          ...
          <div className="hero-contact-grid" style={{ maxWidth: 1200, margin: "0 auto", display: "flex", gap: "4rem", alignItems: "flex-start" }}>
            ...
            <div style={{ flex: "1 1 340px", paddingTop: "1rem" }}>
              ...
              <div style={{ display: "flex", gap: "0.75rem" }}>
                <a href="https://www.facebook.com" className="social-ring" aria-label="Facebook">
                ...
                <a href="https://www.instagram.com" className="social-ring" aria-label="Instagram">
                ...
                <a href="https://www.tiktok.com" className="social-ring" aria-label="TikTok">
